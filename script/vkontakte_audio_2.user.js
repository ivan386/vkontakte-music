...
(function(){
	...
	set_my_style("\
	.download{display: block; float: right; width: 16px; height: 16px;}\
	...
	var commands = (function(){
		...
		conteiner.appendChild(a_tag("http://userscripts.org/scripts/show/100073", text_node("этот скрипт здесь"), null, null, null, "_blank"))
